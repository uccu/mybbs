...
class mysql_database {
	...
	public static function init() {
		self::$db = new mysql_base;
		self::$tran = new main_tran;
	}
	public static function table($table) {
		return self::quote_field($table);
	}
	public static function fetch_first($sql, $arg = array()) {
		$res = self::query($sql.' limit 1', $arg);
	...
	public static function quote($str, $noarray = false,$c=0) {
