...
<root>
  <province name="安徽省">
    ...
    <city name="马鞍山市">
      ...
      <district name="金家庄区" zipcode="243000" />
    ...
    <city name="铜陵市">
      ...
      <district name="狮子山区" zipcode="244000" />
      <district name="铜官山区" zipcode="244000" />
      <district name="铜陵县" zipcode="244000" />
  ...
  <province name="广东省">
    <city name="潮州市">
      ...
      <district name="枫溪区" zipcode="515600" />
    ...
    <city name="广州市">
      ...
      <district name="从化市" zipcode="510000" />
      <district name="东山区" zipcode="510000" />
      <district name="番禺区" zipcode="510000" />
      <district name="芳村区" zipcode="510000" />
      ...
      <district name="萝岗区" zipcode="510000" />
      <district name="天河区" zipcode="510000" />
      <district name="越秀区" zipcode="510000" />
      <district name="增城市" zipcode="510000" />
  ...
  <province name="河北省">
    ...
    <city name="秦皇岛市">
      ...
      <district name="经济技术开发区" zipcode="066000" />
  ...
  <province name="黑龙江省">
    ...
    <city name="大兴安岭地区">
      ...
      <district name="呼中区" zipcode="165000" />
      <district name="加格达奇区" zipcode="165000" />
      <district name="漠河县" zipcode="165000" />
      <district name="松岭区" zipcode="165000" />
      <district name="塔河县" zipcode="165000" />
      <district name="新林区" zipcode="165000" />
  ...
  <province name="湖北省">
    ...
    <city name="黄石市">
      ...
      <district name="团城山开发区" zipcode="435000" />
  ...
  <province name="江西省">
    ...
    <city name="南昌市">
      ...
      <district name="红谷滩新区" zipcode="330000" />
  ...
  <province name="云南省">
    <city name="保山市">
      <district name="昌宁县" zipcode="678000" />
      <district name="龙陵县" zipcode="678000" />
      <district name="隆阳区" zipcode="678000" />
      <district name="施甸县" zipcode="678000" />
      <district name="腾冲县" zipcode="678000" />
  ...
  <province name="重庆市">
    <city name="重庆市">
      ...
      <district name="其他" zipcode="404100" />
		...
		foreach($c->jq('province') as $v){
			$p = $c->jq($v)->attr('name');
			foreach($c->jq($v)->find('city') as $v1){
				$i = $c->jq($v1)->attr('name');
				foreach($c->jq($v1)->find('district') as $v2){
					$d = $c->jq($v2)->attr('name');
					//echo $p.' '.$i.' '.$d.'<br />';
					$data['province'] = $p;
					$data['city'] =$i;
					$data['district'] = $d;
					//model('tool:area')->data($data)->add(true);
				}
			}
