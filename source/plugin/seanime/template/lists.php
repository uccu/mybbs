	...
	<div class="sourceslist_body">
		...
		<ul class="sourceslist_block" sid="{b.sid}">
			...
			<li style="text-align:left">
				...
				<a href="seanime/page/sid/{b.sid}/{b.stimeline}" target="overlay-iframe-2"  class="overlay-in2" ><i>{$b['sname']}</i></a>
...
<div id="overlay-2" class="overlay nos cd">
    ...
    <div class="overlay_box ui-draggable">
        <div class="box-o0"><iframe id="overlay-iframe-2" name="overlay-iframe-2" style="width:800px;height:70%;background:#fff;max-width: 99%;border: 0;"></iframe></div>
    </div>
</div>	
