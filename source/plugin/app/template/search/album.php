...
<div class="container search" style="width: 1022px;">
    <input type="text" class="t" /><button >搜索</button><strong class="fr cp t">用户</strong><strong class="fr cp t active" >相册</strong>
</div>
<script>
!function(){
    j('.search button').click(function(){
        location = '/app/search/album/'+j('.search input').val()
    });
    ...
    j('.search strong:not(.active)').click(function(){
        location = '/app/search/user/'+folder[4];
    })
