...
.alfl1{ font-size:22px; text-align:center; color:#5cbac0; font-weight:bold; margin-top:10px;}
...
<div class="sy_main">
    <div class="ns_main">
            ...
            <div class="cultmain">
    	<div class="zdbox1">
        	<h2 class="bt3">UI设计师</h2>
            <div class="bt2">
                <a href="zxns1"><div class="fanhui">返回列表</div></a>
            </div>
        </div>
        <div class="zdbox1">
        	<ul>
            	<li><span class="img5">工作经验：</span><span class="txt">2年</span></li>
                <li><span class="img5">工作地点：</span><span class="txt">上海或(周边)</span></li>
                <li><span class="img5">学历：</span><span class="txt">专科以上（含专科）</span></li>
                <li style=" width:125px; float:right; font-size:13px;"><div class="img5">招聘人数：</div><div class="txt">6人</div></li>
            </ul>
            <ul>
                <li><span class="img5">薪资待遇：</span><span class="txt">面议</span></li>
                <li><span class="img5">年龄：</span><span class="txt">25-45</span></li>
                <li><span class="img5">性别：</span><span class="txt">男女不限</span></li>
            </ul>
        </div>
        <div class="zdbox1">
        	<span class="spsq"><a href="#"><img src="images/img/zpxq_ico08.gif"></a></span><span class="sp16">&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/img/zpxq_ico09.gif"></span>
        </div>
        <div class="zdbox2">
        <p><strong><span style="font-size:12px;color:#5cbac0">岗位要求：</span></strong></p><p><span style="font-size:12px">&nbsp;&nbsp;&nbsp;&nbsp;
        1.手绘精通，一定要有代表作哦；</span></p><p><span style="font-size:12px">&nbsp;&nbsp;&nbsp;&nbsp;
        2.手绘能力出色，构图及色彩能力扎实；</span></p><p><span style="font-size:12px">&nbsp;&nbsp;&nbsp;&nbsp;
        3.熟练使用PS，AI等图像处理软件；</span></p><p><span style="font-size:12px">&nbsp;&nbsp;&nbsp;&nbsp;
        4.对APP设计有强烈兴趣；</span></p><p><span style="font-size:12px">&nbsp;&nbsp;&nbsp;&nbsp;
        5.处女作极佳，尽情钻牛角尖吧。投递简历时请附带个人作品或主页链接</span></p><p><span style="font-size:12px"><br></span></p><p><strong>
        
        <span style="font-size:12px;color:#5cbac0">任职要求：</span></strong></p><p><span style="font-size:12px">&nbsp;&nbsp;&nbsp;&nbsp;
        1、有良好的审美</span></p><p><span style="font-size:12px">&nbsp;&nbsp;&nbsp;&nbsp;
        2、参与完成公司产品设计及UI设计，共同合作完成产品的最终实现；</span></p><p><span style="font-size:12px">&nbsp;&nbsp;&nbsp;&nbsp;
        3、代表公司与各合作单位、公司各部门之间沟通联络，产品等进出与售后的协调与跟进；</span></p><p><span style="font-size:12px">&nbsp;&nbsp;&nbsp;&nbsp;
        4、及时与总部沟通反馈所在区域市场信息，作出处理意见；</span></p><p><span style="font-size:12px">
        
        <strong>
        <span style="font-size:12px;color:#5cbac0">福利待遇：</span></strong></span></p><p><span style="font-size:12px">&nbsp;&nbsp;&nbsp;&nbsp;
        1、基本工资+提成（第一年无提成，从第二年开始有）；</span></p><p><span style="font-size:12px">&nbsp;&nbsp;&nbsp;&nbsp;
        2、第一年无年终奖（即13薪），第二年开始有；</span></p><p><span style="font-size:12px">&nbsp;&nbsp;&nbsp;&nbsp;
        3、五险一金按国家标准缴纳；</span></p><p><span style="font-size:12px">&nbsp;&nbsp;&nbsp;&nbsp;
        4、国家法定节假日休息，7天带薪休假；</span></p><p><span style="font-size:12px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;工作经历者优先；</span></p><p><span style="font-size:12px">&nbsp;&nbsp;&nbsp;&nbsp;
        5、公司免费提供住宿水电费自缴；</span></p><p><span style="font-size:12px">&nbsp;&nbsp;&nbsp;&nbsp;
        6、试用期为一个月，薪资80%；</span></p><p><span style="font-size:12px"><br></span></p><p>
        
        <strong>
        <span style="font-size:12px;color:#5cbac0">工作时间：</span></strong></p><p><span style="font-size:12px">&nbsp;&nbsp;&nbsp;&nbsp;
        周一至周五&nbsp;上午9:00至12点，午休1小时，下午13:00至6:00，周末双休，无加班；</span></p><p><span style="white-space:nowrap;"><br></span></p><p><span style="font-size:12px;color:#000000;">
        
        采用邮件投递的方式请统一用如下格式，感谢。</span></p><p><span style="font-size:12px;color:#000000;">
        标题：投递的职位+姓名+年龄+工作年限</span></p></div></div></div>
