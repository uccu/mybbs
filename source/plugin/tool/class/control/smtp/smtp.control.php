<?php
namespace plugin\tool\control\smtp;
...
class smtp{
	...
	static function send($smtpemailto='418667631@qq.com',$mailtitle = '邮件测试',$mailcontent = '邮件测试',$mailtype = "HTML"){
		...
		$smtpusermail = "baka@4moe.com";//SMTP服务器的用户邮箱
		$smtpusername='4MOE ANIME';
		//发送给谁
		$smtpuser = "baka@4moe.com";//SMTP服务器的用户帐号
		$smtppass = "6JYTlhNvoR";//SMTP服务器的用户密码
		//邮件主题
		//邮件内容
