...
<div class="container">
    <ol class="breadcrumb">
        ...
        <li><a href="feedback/lists">反馈列表</a></li>
    </ol>
...
<div class="container">
    <div class="col-md-2">
        <div class="list-group">
            <a class="list-group-item active cd">反馈列表</a>
        </div>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <table class="text-center table table-striped sortable-theme-bootstrap" data-sortable>
                    <thead>
                        <tr>
                            <th class="text-center">反馈ID</th>
                            <th class="text-center">反馈者</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{p.content}</td>
                            <td>
                                <a href="user/lists/1/{p.phone}" type="button" class="btn btn-info">查看用户</a>
                            </td>
                        </tr>
                        <!--{/loop}-->
                    </tbody>
...
<script>
   var goods = 'feedback',control = 'feedback';
   j('.search').click(()=>{
