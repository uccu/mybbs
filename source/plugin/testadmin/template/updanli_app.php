...
<form id="form" data-default="{g.plugin}/api/get_anli_app/{id}">
    ...
    <div class="form-group">
        <button type="button" class="btn btn-success insave t" for="form" data-action="_{g.plugin}/api/set_anli_app/{id}">保存</button>
    </div>
</form>
