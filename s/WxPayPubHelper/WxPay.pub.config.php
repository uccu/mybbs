...
class WxPayConf_pub
{
	...
	const APPID = 'wxd9454f19394d5949';
	//受理商ID，身份标识
	const MCHID = '1394351202';
	//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
	const KEY = '7EA97FA5C1534CD91FE666690A60E927';
	//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
	const APPSECRET = '78e2dab5b9824a3a690ac942a36b8763';
	...
	const NOTIFY_URL = 'http://csmax.profex.com/weipay_return.php';
